...
echo "<a href=\"list.php\">List of users</a> | $br$br";
echo "<a href=\"Compositions.php\">Poems</a> | $br$br";
echo "<a href=\"recom.php\">User's Suggestions</a> | $br$br";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        <h1>WELCOME  TO  POEM  UPLOADER</h1>
</body>
<script>const target = window.document.getElementsByTagName('h1')[0]
